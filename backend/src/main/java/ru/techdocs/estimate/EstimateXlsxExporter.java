...
public class EstimateXlsxExporter {
    ...
    /** Ширины колонок в символах — как в эталоне. */
    private static final int[] WIDTHS = {
            9, 40, 18, 16, 34, 18, 65, 14, 30, 13, 13, 13, 13, 13,
            13, 13, 13, 13, 11, 14, 11, 11, 13, 12, 12, 13, 11, 15,
            12, 12, 12, 12, 12, 12, 12, 12, 12, 11, 13, 12, 16, 14, 14
    };
    ...
    private void writeCalcSheet(Workbook wb, Styles st, Estimate estimate, java.util.List<EstimateRow> rows) {
        ...
        sheet.createFreezePane(9, 2);       // держим описание строки и шапку на виду
